...
- [x] Build Axe v1 and deploy the backend
- [x] Add Google sign-in and connect website accounts to the extension
- [x] Implement Razorpay subscriptions with Neon-backed entitlements
- [x] Complete the ₹1 subscription purchase in Razorpay Test Mode
- [x] Verify signed Razorpay webhook processing and extension unlocking in Test Mode
...
- [ ] Protect paid API endpoints with a server-enforced usage allowance before access expands beyond private testing
